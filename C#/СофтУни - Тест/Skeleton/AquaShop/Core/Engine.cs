        ...
        public void Run()
        {
            while (true)
            {
                ...
                try
                {
                    ...
                    else if (input[0] == "SwitchLights")
                    {
                        string aquariumName = input[1];

                        result = controller.SwitchLights(aquariumName);
                    }
                    ...
                    else if (input[0] == "InitiateHunt")
                    {
                        string aquariumName = input[1];
                        string attackerName = input[2];
                        string defenderName = input[3];

                        result = controller.InitiateHunt(aquariumName, attackerName, defenderName);
                    }
